...
Tags: blog, education, one-column, custom-logo, custom-background, custom-header, custom-menu,
threaded-comments, translation-ready, sticky-post, theme-options, footer-widgets, editor-style
Tested up to: 5.5
Stable tag: 1.0.9
Requires PHP: 5.6.0
...
fTravel is a Fully Responsive Tourism WordPress Theme.

== Description ==

fTravel is a Fully Responsive Tourism WordPress Theme, a perfect choice for a travel agency website,
hotels and travel agencies review blog, traveling worldwide and tourism blog, travel agents site,
tour operator or tourism company website, etc. Features include Built-in Homepage Slider (Displayed Only
on a Static Front Page), Animations Appearing Effect, Custom Logo, Multi-level Drop-down Menut,
Custom Background, Homepage Widget Area, Footer Widget Area, Footer Menu, Footer Copyright Text,
Search Engine Optimized, Multiple Browsers Support, and Translation-Ready.
DEMO: https://tishonator.com/demo/ftravel
...
= 1.2.2 =
* hide sidebar on a Static Front Page
* add theme demo URL
...
* move change log into readme.txt file
...
* add Instagram Widget plugin support

= 1.0.2 =
* add animations appearing effects
* add footer menu
...
* img/1.jpg, © 2017 @pxhere https://pxhere.com/en/photo/990553, CC0
* img/2.jpg, © 2017 @pxhere https://pxhere.com/en/photo/949573, CC0
* img/3.jpg, © 2017 @pxhere https://pxhere.com/en/photo/961519, CC0
* screenshot.png (slider image), © 2017 @pxhere https://pxhere.com/en/photo/990553, CC0
